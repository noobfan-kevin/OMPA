...
utils.getServer = function(){
    return require(path.join(utils.getProjectRoot(),'server/src/core/Server'));
};

utils.getConfig = function () {
    return require(path.join(utils.getProjectRoot(),'server/src/config'));
};
